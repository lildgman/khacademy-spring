        ...
        <div class="innerOuter">
            ...
            <form action="insert.me" method="post" id="enrollForm">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="userId" placeholder="Please Enter ID" name="userId"
                        required>
                    ...
                    <input type="password" class="form-control" id="checkPwd" placeholder="Please Enter Password"
                        required> <br>
